...
export class Home extends LitElement {
    ...
    render() {
        return html`
            ...
            <div>
                <div class="max-w-3xl mx-auto py-24 px-8">
                    <div class="text-2xl text-neutral-800 mb-4">Travel</div>
                    <div class="mb-4">
                        <a
                            class="sm:text-2xl text-secondary-800 hover:text-secondary-600 inline-flex items-center"
            ...
            <!-- 
            <div class="max-w-3xl mx-auto py-24 px-8">
                <div class="text-5xl text-neutral-800 mb-4">Attire</div>
                <div>
                    <a
